    ...
    books = [
      {
        ...
        osis: ["2Sam"],
        regexp: RegExp("(\\b)(" + bcv_parser.prototype.regexps.second + "(?:Samu[ae]l[ls]?|Sam|Sma|S[am]?|Kingdoms))(?:\\b|(?=\\d))", "gi")
      }, {
        osis: ["1Sam"],
        regexp: RegExp("(\\b)((?:" + bcv_parser.prototype.regexps.first + ")?Samu[ae]l[ls]?|" + bcv_parser.prototype.regexps.first + "(?:Sam|Sma|S[am]?|Kingdoms))(?:\\b|(?=\\d))", "gi")
      }, {
        osis: ["2Kgs"],
